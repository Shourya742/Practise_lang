...
/// macro trick, anonymous const 
/// anonymous const here which is used to generate a new scope where we know that we can only have impulse, where we know that we can control the namespace a little better
/// 
const _: () = {

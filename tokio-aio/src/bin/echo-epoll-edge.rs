...
/// read and writes. This program uses edge-triggered events, which can
...
/// which time epoll_wait() is called again and other file descriptors may
...
fn main() {
    ...
    loop {
        ...
        if can_read && !outgoing_queue.is_empty() {
